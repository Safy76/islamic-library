...
private val DarkColorScheme =
  darkColorScheme(
    ...
    surfaceVariant = HighDensityHeaderDark,
    onPrimary = Color.Black,
    onSecondary = Color.Black,
    onBackground = HighDensityTextDark,
    onSurface = HighDensityTextDark,
    secondaryContainer = HighDensityAccentDark,
    onSecondaryContainer = HighDensitySecondaryDark
  )
...
private val LightColorScheme =
  lightColorScheme(
    ...
    surfaceVariant = HighDensityHeaderLight,
    onPrimary = Color.White,
    onSecondary = Color.White,
    onBackground = HighDensityTextLight,
    onSurface = HighDensityTextLight,
    secondaryContainer = HighDensityAccentLight,
    onSecondaryContainer = HighDensityPrimaryDarkGreen,
    onSurfaceVariant = HighDensityTextMutedLight
  )
